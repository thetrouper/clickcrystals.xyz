          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            {Array(6)
              ...
              .map((_, i) => (
                <div
                  key={i}
                  className="border border-slate-800 bg-gradient-to-r from-slate-900/30 via-slate-800/40 to-slate-900/30 rounded-lg p-4 animate-shimmer bg-[length:200%_100%]"
                >
