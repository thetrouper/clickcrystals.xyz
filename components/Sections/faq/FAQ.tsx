...
const faqs = [
    ...
    answer: (
      <>
        ...
        <Image
          ...
          width={900}
          height={300}
          alt="ClickCrystals withheld on Modrinth"
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        removed Discord RPC or get off Mac/PojavLauncher and get a real PC.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        Avoid downloading files from untrusted sources or accepting files from
        unknown individuals.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        CCS (ClickCrystals Script, aka ClickScript) is an in-game tool that
        allows you to create custom modules. It functions similarly to creating
        datapacks, enabling a high level of customization within the game.
        <br />
        <br />
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <br />
        <br />
        Long answer: ClickCrystals is not a cheat, it does not automate any
        task; every action requires direct player input. The mod itself does not
        provide any inherent unfair advantages unless the user creates a macro
        using the ClickCrystals script.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        While ClickCrystals is designed to avoid providing unfair gameplay
        advantages, some servers may still ban players for using it.
        <br />
        <br />
        To minimize the risk:
        <br />
        - The mod is designed not to trigger anti-cheat systems.
        <br />
        - It appears as normal gameplay in third-person view.
        <br />
        - It maintains its logs separately from the vanilla logs (except error
        traces), which can be deleted if necessary.
        <br />
        <br />
        Important: Ensure you are using the latest version of ClickCrystals, as
        older versions included a command (!cc -users) that could be exploited
        to ban players.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        By pressing the apostrophe key. If you don&apos;t know what it is,
        you&apos;re a third grader that shouldn&apos;t be play games and should
        be studying instead.
        <Image
          src={'/img/key.png'}
          width={900}
