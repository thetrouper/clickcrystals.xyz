...
export default function DownloadTable() {
  ...
  const mobileVersions = ['12111', '12110', '1219', '1218', '1217', '1216', '1215', '1214', '1211', '121', '1206', '1204', '1202', '1201', '120', '1194'];
      ...
      <div className="mt-8 mb-8">
        <p className="text-sm text-slate-300 mb-4 md:mb-8 leading-relaxed md:leading-loose space-y-4 md:space-y-6">
          ...
          <span className="hidden md:block">
            <span className="font-semibold text-slate-300">Note:</span> Scroll right for more versions and down for older releases.
          </span>
        </p>
          ...
          {loading ? (
            ...
            mobileVersions.map((ver) => {
              ...
              const href = ver === '1214'
                ...
                : release?.[ver];
              const version = ver === '1214' ? '1.2.9' : ver === '1211' || ver === '121' ? '1.2.9-1.3.7' : release?.version;
              if (!href) return null;
              return (
                <a
                  key={ver}
                ...
                >
                  <div>
                    ...
                    <span className="text-slate-400 text-xs ml-2">
                      v{version}{(ver === '1211' || ver === '121') && <span className="text-yellow-500 text-[10px] uppercase font-semibold px-1.5 py-0.5"> exp</span>}
                    </span>
                  </div>
