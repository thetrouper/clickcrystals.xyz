        ...
        <div className="place-self-center col-span-5 lg:col-span-7">
          ...
          <div className="flex flex-row gap-4 justify-center lg:justify-start">
            <Container tapScale={0.95}>
              <Link href="/download" className="ring-[#737679] btn border-gray-400 bg-transparent hover:bg-gray-700 hover:text-white font-semibold px-6 px-5.5 py-2.5 shadow-none text-sm">Get ClickCrystals!</Link>
            </Container>
            <Container tapScale={0.95}>
              <Link href="https://discord.gg/zg3ge9VTgr" className="ring-[#4287f5] btn border-[#7289da] bg-[#7289da] hover:bg-[#546abb] font-semibold px-6 px-5.5 py-2.5 shadow-none text-white text-sm">Join Discord</Link>
            </Container>
          </div>
        </div>
