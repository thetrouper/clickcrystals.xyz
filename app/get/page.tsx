    ...
    <main className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center">
        ...
        <Link
          ...
          className="inline-block px-8 py-3 sm:py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-full transition-all text-base border border-blue-700 shadow-[inset_0_1px_0_0_rgba(96,165,250,0.3)]"
        >
          Download Latest
        </Link>
      </div>
